...
// and basic punctuation. This is useful for creating search queries that work better
// with music streaming service APIs.
...
// BuildJapaneseSearchQuery creates a search query from track name and artist,
// converting Japanese to romaji if present.
func BuildJapaneseSearchQuery(trackName, artistName string) string {
	...
	trackClean := CleanToASCII(trackRomaji)
	artistClean := CleanToASCII(artistRomaji)
